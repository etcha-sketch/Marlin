...
// @section bltouch
   ...
   */
  //#define BLTOUCH_HS_MODE true //TJZ-Enable
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -1.0 //TJZ
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          //TJZ // Combine M851 Z and Babystepping
 ...
 */
#define ADVANCED_PAUSE_FEATURE //TJZ
